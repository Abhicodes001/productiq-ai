    ...
    <div className="min-h-screen bg-industrial-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative bg-industrial-grid">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <Link to="/" className="inline-flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-red-600 to-red-950 flex items-center justify-center text-white border border-red-500/40 shadow-md shadow-red-950/50">
            <Cpu className="w-6 h-6 text-red-100" />
          </div>
          <span className="text-xl font-bold text-white tracking-tight">
            ProductIQ <span className="text-red-400 font-mono text-sm px-1.5 py-0.5 rounded bg-red-950 border border-red-800">AI</span>
          </span>
        </Link>
